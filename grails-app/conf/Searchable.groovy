...
searchable {
    ...
    compassConnection = new File(
        "${userHome}/.grails/projects/${appName}/searchable-index/idx"
    ).absolutePath
...
environments {
    development {
	    ...
	    compassConnection = new File(
		"${userHome}/.grails/projects/${appName}/searchable-index/idxIcsDev"
	    ).absolutePath
        }
    }
    ...
    test {
	    ...
	    compassConnection = new File(
		"${userHome}/.grails/projects/${appName}/searchable-index/idxIcsTest"
	    ).absolutePath
        }
    }
    ...
    production {
        searchable {
            ...
            bulkIndexOnStartup = "fork"
	    compassConnection = new File(
		"${userHome}/.grails/projects/${appName}/searchable-index/idxIcsProd"
	    ).absolutePath
	}
    }
}
