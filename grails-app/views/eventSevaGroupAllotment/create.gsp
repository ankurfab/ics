...
<html>
    <head>
        ...
        <title><g:message code="eventSevaGroupAllotment.create" default="Create EventSevaGroupAllotment" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="eventSevaGroupAllotment.create" default="Create EventSevaGroupAllotment" /></h1>
