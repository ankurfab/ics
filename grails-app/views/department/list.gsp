			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="creator" title="${message(code: 'department.creator.label', default: 'Creator')}" />
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'department.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="updator" title="${message(code: 'department.updator.label', default: 'Updator')}" />
					
						<g:sortableColumn property="lastUpdated" title="${message(code: 'department.lastUpdated.label', default: 'Last Updated')}" />
					
						<th><g:message code="department.centre.label" default="Centre" /></th>
				...
				<g:each in="${departmentInstanceList}" status="i" var="departmentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: departmentInstance, field: "creator")}</td>
					
						<td><g:formatDate date="${departmentInstance.dateCreated}" /></td>
					
						<td>${fieldValue(bean: departmentInstance, field: "updator")}</td>
					
						<td><g:formatDate date="${departmentInstance.lastUpdated}" /></td>
					
						<td>${fieldValue(bean: departmentInstance, field: "centre")}</td>
