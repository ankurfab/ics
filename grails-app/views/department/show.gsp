	...
	<body>
		...
		<div id="show-department" class="content scaffold-show" role="main">
			...
			<ol class="property-list department">
				...
				<g:if test="${departmentInstance?.creator}">
				<li class="fieldcontain">
					<span id="creator-label" class="property-label"><g:message code="department.creator.label" default="Creator" /></span>
					
						<span class="property-value" aria-labelledby="creator-label"><g:fieldValue bean="${departmentInstance}" field="creator"/></span>
				...
				<g:if test="${departmentInstance?.updator}">
				<li class="fieldcontain">
					<span id="updator-label" class="property-label"><g:message code="department.updator.label" default="Updator" /></span>
					
						<span class="property-value" aria-labelledby="updator-label"><g:fieldValue bean="${departmentInstance}" field="updator"/></span>
				...
				<g:if test="${departmentInstance?.centre}">
				<li class="fieldcontain">
					<span id="centre-label" class="property-label"><g:message code="department.centre.label" default="Centre" /></span>
					
						<span class="property-value" aria-labelledby="centre-label"><g:link controller="centre" action="show" id="${departmentInstance?.centre?.id}">${departmentInstance?.centre?.encodeAsHTML()}</g:link></span>
