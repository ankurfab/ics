...
<html>
    <head>
        ...
        <title><g:message code="batchItem.edit" default="Edit BatchItem" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="batchItem.edit" default="Edit BatchItem" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${batchItemInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
