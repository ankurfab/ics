...
<html>
    ...
    <body >
		...
		<g:form action="patronCareDashboard" method="post">
                <div class="dialog">
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tbody bgcolor="lavender">
			<g:if test="${patronCareSevaks.size() > 0}">
				<tr class="prop">
					<td valign="top" class="name">
					    PatronCare Devotee
					</td>
					<td valign="top" class="value">
						<g:select name="patronCareSevaks.id"  optionKey="id" from="${patronCareSevaks}" value=""  />
					</td>
				</tr>
			</g:if>
			<tr class="prop">
