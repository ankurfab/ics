<html>
    <head>
        ...
        <title>Datewise Councellor Councelle Report</title>
    ...
    <script type="text/javascript">
        ...
        <div class="body">
            <h1>Datewise Councellor Councelle Report</h1>
            <g:if test="${flash.message}">
            <div class="message">${flash.message}</div>
            </g:if>
            <g:form controller='helper' action="datewiseCouncellorViewReport" method="post">
                <div class="dialog">
                    <table>
                        <tbody>
                            <tr class="prop">
				    ...
				    />
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: roleInstance, field: 'name', 'errors')}">
                                    <g:textField name="fromDate" value="${(new Date()-1)?.format('dd-MM-yyyy')}"/>
                                </td>
                            </tr>
