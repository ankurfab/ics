	...
	<script type="text/javascript" charset="utf-8">
        ...
        <div class="body">
		   ...
		   <div id="ft">
			...
			<a style="text-decoration:underline; color:black;" href="http://www.iskconpune.com">Datewise Advance Donation Detailed Report</a>
                ...
                <table id="example">
                    ...
                    <tbody>
                        ...
                        <tr class="none"}">
                            ...
                            <td align="right">${loanInstance?.amount}</td>
