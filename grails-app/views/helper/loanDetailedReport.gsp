<html>
    <head>
        ...
        <title>Advance Donation Detailed Report</title>
	...
	<script type="text/javascript" charset="utf-8">
		...
		<div id="ft">
			...
			<a style="text-decoration:underline; color:black;" href="http://www.iskconpune.com">Advance Donation Detailed Report</a>
		...
		<br>
                ...
                <table id="example">
                    ...
                    <tbody>
                    	<g:each in="${loanList}" status="i" var="loanInstance">
                        <tr class="none"}">
			    ...
			    <td valign="top" class="value">${counsellor}</td>
                            ...
                            <td>${loanInstance?.reference1?.toString()}</td>
