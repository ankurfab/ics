<html>
    <head>
        ...
        <title>Citywise Collections Report</title>
	...
	<script type="text/javascript" charset="utf-8">
        ...
        <div class="nav">
            <span class="menuButton"><a class="home" href="${createLink(uri: '/')}">Citywise Collections Report</a></span>
        </div> 
