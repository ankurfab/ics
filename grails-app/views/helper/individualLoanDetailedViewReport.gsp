<html>
	...
	<script type="text/javascript" charset="utf-8">
		...
		<div id="ft">
				...
				<a style="text-decoration:underline; color:black;" href="http://www.iskconpune.com">Individualwise Advance Donation Detailed Report</a>

		</div>
		<br>
		<div>
			<b>Individual: ${individual}<b>
		</div>
 		<br>
                <table id="example">
                    <thead>
                    ...
                    <tbody>
                    	...
                    	<g:each in="${individualLoanDetailedList}" status="i" var="loanInstance">
                        <tr class="none"}">
