                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="addresses"><g:message code="city.addresses.label" default="Addresses" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: cityInstance, field: 'addresses', 'errors')}">
...
<g:link controller="address" action="create" params="['city.id': cityInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'address.label', default: 'Address')])}</g:link>
