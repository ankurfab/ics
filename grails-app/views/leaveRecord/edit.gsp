...
<html>
    <head>
        ...
        <title><g:message code="leaveRecord.edit" default="Edit LeaveRecord" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="leaveRecord.edit" default="Edit LeaveRecord" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${leaveRecordInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
