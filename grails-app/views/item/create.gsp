...
<html>
    <head>
        ...
        <title><g:message code="item.create" default="Create Item" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="item.create" default="Create Item" /></h1>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="category"><g:message code="item.subcategory" default="SubCategory" />:</label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value"><input type="file" name="image1" id="image1" /></td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value"><input type="file" name="image2" id="image2" /></td>
