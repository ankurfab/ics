                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="ackRef"><g:message code="denomination.ackRef.label" default="Ack Ref" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: denominationInstance, field: 'ackRef', 'errors')}">
                                    <g:textField name="ackRef" value="${denominationInstance?.ackRef}" />
                                </td>
                            </tr>
