...
<html>
    <head>
        ...
        <title><g:message code="eventPrasadam.edit" default="Edit EventPrasadam" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="eventPrasadam.edit" default="Edit EventPrasadam" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${eventPrasadamInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
