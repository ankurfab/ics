...
<html>
    <head>
        ...
        <title><g:message code="sadhana.edit" default="Edit Sadhana" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="sadhana.edit" default="Edit Sadhana" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${sadhanaInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
