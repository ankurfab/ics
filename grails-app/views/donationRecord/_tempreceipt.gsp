...
Receipt No: 
<b>
<g:if test="${donationRecordInstance.rno}">
	${donationRecordInstance.rbno}/${donationRecordInstance.rno}
</g:if>
<g:else>
	${donationRecordInstance.id}
</g:else>
</b>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<br>
<br>
<div style="text-align:left"><g:link controller="donationRecord" action="quickCreate" >ISKCON Pune Donation Receipt - Department Copy</g:link></div><br>
Receipt No: 
<b>
<g:if test="${donationRecordInstance.rno}">
	${donationRecordInstance.rbno}/${donationRecordInstance.rno}
...
By: <b>${donationRecordInstance.mode} ${donationRecordInstance.mode?.name!="Cash"?(" No:"+donationRecordInstance?.transactionId+" Bank: "+donationRecordInstance?.paymentDetails+" Branch: "+donationRecordInstance?.transactionDetails):""}</b><br>
<br>
Remarks: ${donationRecordInstance.comments}
<br>
<b>Note:</b>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
