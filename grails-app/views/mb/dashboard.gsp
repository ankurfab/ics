          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="${resource(dir:'img',file:'user2-160x160.jpg')}" class="img-circle" alt="User Image"/>
                          </div>
                          <h4>
                            Support Team
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="${resource(dir:'img',file:'user2-160x160.jpg')}" class="user-image" alt="User Image"/>
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      <img src="${resource(dir:'img',file:'user2-160x160.jpg')}" alt="User Image"/>
