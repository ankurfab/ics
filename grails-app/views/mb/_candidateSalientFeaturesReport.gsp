...
<script>
  $(document).ready(function () {
    jQuery("#result_list").jqGrid({
      url:'jq_salientFeatures_list',
      datatype: "json",
      colNames:['DB','Centre','Gender','WorkflowStatus','Name','Income','Languages','Height','Weight','Education','Qualification','SpiritualMaster','Id'],
      colModel:[
	...
	{name:'income', search:true},	
	{name:'languagesKnown', search:true},	
	{name:'height', search:true},	
	{name:'weight', search:true},	
	{name:'eduCat', search:true},	
	{name:'eduQual', search:true},	
	{name:'spiritualMaster', search:true},	
	{name:'id',hidden:true}
     ],
    ...
    height: "100%",
    multiselect: false,
    caption:"Candidate Salient Features Report"
    });
