...
<html>
    <head>
        ...
        <title><g:message code="giftRecord.edit" default="Edit GiftRecord" /></title>
    </head>
    <body>
    ...
    <script type="text/javascript">
        ...
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="create" action="create"><g:message code="giftRecord.new" default="New GiftRecord" /></g:link></span>
        </div>
        <div class="body">
            <h1><g:message code="giftRecord.edit" default="Edit GiftRecord" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${giftRecordInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                             ...
                             <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: giftRecordInstance, field: 'scheme', 'errors')}">
                                    <g:select name="scheme.id" from="${schemes}" optionKey="id" value="${giftRecordInstance?.scheme?.id}" noSelection="['null': '']" />
