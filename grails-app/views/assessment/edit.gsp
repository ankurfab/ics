...
<html>
    <head>
        ...
        <title><g:message code="assessment.edit" default="Edit Assessment" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="assessment.edit" default="Edit Assessment" /></h1>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="questionPapers"><g:message code="assessment.questionPapers" default="Question Papers" />:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: assessmentInstance, field: 'questionPapers', 'errors')}">
