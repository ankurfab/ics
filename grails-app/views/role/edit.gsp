    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="category"><g:message code="role.category.label" default="Category" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: roleInstance, field: 'category', 'errors')}">
                                    <g:textField name="category" value="${roleInstance?.category}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="individualRoles">Individuals</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: roleInstance, field: 'individualRoles', 'errors')}">
				...
				<g:link controller="individualRole" action="create" params="['role.id': roleInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'individualRole.label', default: 'IndividualRole')])}</g:link>
