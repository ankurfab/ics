                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="address.individual.label" default="Individual" /></th>
                   	    
                            <g:sortableColumn property="category" title="${message(code: 'address.category.label', default: 'Category')}" />
                    ...
                    <g:each in="${addressInstanceList}" status="i" var="addressInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: addressInstance, field: "individual")}</td>
                        
                            <td>${fieldValue(bean: addressInstance, field: "category")}</td>
