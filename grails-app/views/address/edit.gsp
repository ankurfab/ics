					...
					<g:select name="category" from="${['Correspondence','Permanent','Company','Location','Other']}" value="${addressInstance?.category}" />
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: addressInstance, field: 'city', 'errors')}">
                                    <g:select name="city.id" from="${ics.City.list(sort:'name')}" optionKey="id" value="${addressInstance?.city?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: addressInstance, field: 'state', 'errors')}">
                                    <g:select name="state.id" from="${ics.State.list(sort:'name')}" optionKey="id" value="${addressInstance?.state?.id}"  />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: addressInstance, field: 'country', 'errors')}">
                                    <g:select name="country.id" from="${ics.Country.list(sort:'name')}" optionKey="id" value="${addressInstance?.country?.id}"  />
                                </td>
                            </tr>
