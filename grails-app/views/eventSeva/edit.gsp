...
<html>
    <head>
        ...
        <title><g:message code="eventSeva.edit" default="Edit EventSeva" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="eventSeva.edit" default="Edit EventSeva" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${eventSevaInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
