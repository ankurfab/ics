...
<html>
	<head>
		...
		<title>Cards Arrived List</title>
	...
	<body>
		...
		<div id="cardsArrivedList-lifeMembershipCard" class="content scaffold-cardsArrivedList" role="main">
			...
			<table id="example">
				...
				<tbody>
				<g:each in="${cardsArrivedList}" status="i" var="lifeMembershipCardInstance">
			...
			<div class="pagination">
				<g:paginate total="${cardsArrivedListTotal}" />
			</div>
			<sec:ifNotGranted roles="ROLE_PATRONCARE,ROLE_PATRONCARE_USER">
			    <br>
			    <div class="buttons">
				<g:form name="markAsCardsDeliveredForm" controller="lifeMembershipCard" action="markAsCardsDelivered" >
					...
					<span class="button"><g:actionSubmit name="markAsCardDelivered" class="save" action="markAsCardsDelivered" onclick="return markAsCardsDelivered();" value="Mark as 'Card Delivered'" /></span>
				</g:form>
			    </div>
			</sec:ifNotGranted>
		</div>
