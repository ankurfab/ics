...
<html>
    <head>
        ...
        <title><g:message code="individualAssessment.create" default="Create IndividualAssessment" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="individualAssessment.create" default="Create IndividualAssessment" /></h1>
