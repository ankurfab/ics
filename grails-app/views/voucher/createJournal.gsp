                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: voucherInstance, field: 'type', 'errors')}">
                                    	<g:textField name="type" value="${voucherInstance?.type?:'Journal'}"  readonly="readonly"/>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="ledger">From A/C:</label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="anotherLedger">To A/C:</label>
                                </td>
