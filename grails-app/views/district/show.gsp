...
<html>
    <head>
        ...
        <title><g:message code="district.show" default="Show District" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="district.show" default="Show District" /></h1>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="district.id" default="Id" />:</td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="district.name" default="Name" />:</td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name"><g:message code="district.talukas" default="Talukas" />:</td>
                                
                                <td  valign="top" style="text-align: left;" class="value">
                                    <ul>
                                    <g:each in="${districtInstance?.talukas.sort{it.name}}" var="talukaInstance">
