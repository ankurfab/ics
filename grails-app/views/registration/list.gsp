			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="comments" title="${message(code: 'registration.comments.label', default: 'Comments')}" />
				...
				<g:each in="${registrationInstanceList}" status="i" var="registrationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${registrationInstance.id}">${fieldValue(bean: registrationInstance, field: "comments")}</g:link></td>
