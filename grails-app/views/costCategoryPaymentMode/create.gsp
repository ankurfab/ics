...
<html>
    <head>
        ...
        <title><g:message code="costCategoryPaymentMode.create" default="Create CostCategoryPaymentMode" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="costCategoryPaymentMode.create" default="Create CostCategoryPaymentMode" /></h1>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: costCategoryPaymentModeInstance, field: 'paymentMode', 'errors')}">
                                    <g:select name="paymentMode.id" from="${ics.PaymentMode.findAllByInperson(true,[sort:'name'])}" optionKey="id" value="${costCategoryPaymentModeInstance?.paymentMode?.id}"  />
