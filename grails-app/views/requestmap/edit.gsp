                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: requestmapInstance, field: 'configAttribute', 'errors')}">
                                    ...
                                    <g:select multiple="multiple" name="configAttribute" from="${com.krishna.IcsRole.list(sort:'authority')}" optionKey="authority" value="${requestmapInstance?.configAttribute?.tokenize(',')}"  size="10"/>
                                </td>
                            </tr>
