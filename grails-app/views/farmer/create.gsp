...
<html>
    <head>
        ...
        <title><g:message code="farmer.create" default="Create Farmer" /></title>
    ...
    <body>
        ...
        <div class="body">
            <h1><g:message code="farmer.create" default="Create Farmer Profile" /></h1>
		...
		<legend><b>A: Personal Details</b></legend>
				...
				<g:select name="category" from="${["General","Coordinator","Spokesperson","VIP"]}" value="${farmerInstance?.category?:'General'}"
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: farmerInstance, field: 'farmingProcess', 'errors')}">
                                    <g:select name="farmingProcess" from="${farmerInstance.constraints.farmingProcess.inList}" value="${farmerInstance.farmingProcess?:'Non-Organic'}" valueMessagePrefix="farmer.farmingProcess"  />
