...
<html>
	...
	<body>
				...
				rules: {
				    ...
				    maxPrabhujis: {
				      ...
				      max: function(element) {
				        alert(parseInt($("#maxCapacity").val()) - parseInt($("#maxMatajis").val()) - parseInt($("#maxChildrens").val()));
		...
		<div id="edit-eventAccommodation" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${eventAccommodationInstance}" var="error">
