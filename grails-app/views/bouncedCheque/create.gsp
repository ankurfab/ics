            ...
            <g:form action="save" method="post" >
                <div class="dialog">
                    <table>
		                ...
		                <td valign="top" class="value ${hasErrors(bean: bouncedChequeInstance, field: 'bank', 'errors')}">
		                    <g:select name="bank.id" from="${ics.Bank.list(sort:'name')}" optionKey="id" value="${bouncedChequeInstance?.bank?.id}"  noSelection="['':'-Select-']"/>
		                </td>
