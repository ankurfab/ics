...
<html>
    <head>
        ...
        <title><g:message code="commitment.edit" default="Edit Commitment" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="commitment.edit" default="Edit Commitment" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${commitmentInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
