...
<html>
    <head>
        ...
        <title><g:message code="eventVolunteer.create" default="Create EventVolunteer" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="eventVolunteer.create" default="Create EventVolunteer" /></h1>
