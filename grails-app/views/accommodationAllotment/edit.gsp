...
<html>
    <head>
        ...
        <title><g:message code="accommodationAllotment.edit" default="Edit AccommodationAllotment" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="accommodationAllotment.edit" default="Edit AccommodationAllotment" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${accommodationAllotmentInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
